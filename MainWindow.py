...
"}")
        ...
        self.lcdSpeed = QtWidgets.QLCDNumber(self.groupBox_2)
        self.lcdSpeed.setObjectName("lcdSpeed")
        self.gridLayout.addWidget(self.lcdSpeed, 5, 4, 2, 1)
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.label_14 = QtWidgets.QLabel(self.groupBox_2)
        self.label_14.setStyleSheet("font: 100 10pt \"MS Shell Dlg 2\";\n"
"font-weight: bold;\n"
"color: rgb(170, 85, 0);")
        ...
        self.gridLayout.addLayout(self.verticalLayout_10, 0, 6, 1, 3)
        ...
        self.radioBtnFoot1 = QtWidgets.QRadioButton(self.groupBox_8)
        self.radioBtnFoot1.setObjectName("radioBtnFoot1")
        self.verticalLayout_8.addWidget(self.radioBtnFoot1)
        self.radioBtnFoot10 = QtWidgets.QRadioButton(self.groupBox_8)
        self.radioBtnFoot10.setObjectName("radioBtnFoot10")
        self.verticalLayout_8.addWidget(self.radioBtnFoot10)
        self.gridLayout.addWidget(self.groupBox_8, 5, 7, 2, 1)
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.label_18 = QtWidgets.QLabel(self.groupBox_2)
        self.label_18.setObjectName("label_18")
        self.horizontalLayout_13.addWidget(self.label_18)
        self.spinBoxArmOffset = QtWidgets.QSpinBox(self.groupBox_2)
        self.spinBoxArmOffset.setStyleSheet("background-color: rgb(170, 170, 127);")
        self.spinBoxArmOffset.setObjectName("spinBoxArmOffset")
        self.horizontalLayout_13.addWidget(self.spinBoxArmOffset)
        self.gridLayout.addLayout(self.horizontalLayout_13, 6, 11, 1, 1)
        ...
        self.pushBtnRotateRight.setMinimumSize(QtCore.QSize(100, 70))
        self.pushBtnRotateRight.setObjectName("pushBtnRotateRight")
        self.gridLayout.addWidget(self.pushBtnRotateRight, 5, 16, 2, 1)
        ...
        self.pushBtnRotateLeft.setMinimumSize(QtCore.QSize(100, 70))
        self.pushBtnRotateLeft.setObjectName("pushBtnRotateLeft")
        self.gridLayout.addWidget(self.pushBtnRotateLeft, 5, 14, 2, 1)
        self.lcdFoot = QtWidgets.QLCDNumber(self.groupBox_2)
        self.lcdFoot.setObjectName("lcdFoot")
        self.gridLayout.addWidget(self.lcdFoot, 5, 8, 2, 1)
        ...
        self.pushBtnMoveForward.setMinimumSize(QtCore.QSize(100, 70))
        self.pushBtnMoveForward.setObjectName("pushBtnMoveForward")
        self.gridLayout.addWidget(self.pushBtnMoveForward, 0, 15, 1, 1)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.sliderFoot = QtWidgets.QSlider(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sliderFoot.sizePolicy().hasHeightForWidth())
        self.sliderFoot.setSizePolicy(sizePolicy)
        self.sliderFoot.setMinimumSize(QtCore.QSize(0, 50))
        self.sliderFoot.setMaximum(100)
        self.sliderFoot.setOrientation(QtCore.Qt.Vertical)
        self.sliderFoot.setObjectName("sliderFoot")
        self.horizontalLayout_10.addWidget(self.sliderFoot)
        self.gridLayout.addLayout(self.horizontalLayout_10, 5, 6, 2, 1)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_17 = QtWidgets.QLabel(self.groupBox_2)
        self.label_17.setObjectName("label_17")
        self.horizontalLayout_5.addWidget(self.label_17)
        self.spinBoxArmDistance = QtWidgets.QSpinBox(self.groupBox_2)
        self.spinBoxArmDistance.setAutoFillBackground(False)
        self.spinBoxArmDistance.setStyleSheet("background-color: rgb(170, 170, 127);")
        self.spinBoxArmDistance.setMaximum(360)
        self.spinBoxArmDistance.setProperty("value", 90)
        self.spinBoxArmDistance.setObjectName("spinBoxArmDistance")
        self.horizontalLayout_5.addWidget(self.spinBoxArmDistance)
        self.gridLayout.addLayout(self.horizontalLayout_5, 5, 11, 1, 1)
        ...
        self.radioBtnSpeed1 = QtWidgets.QRadioButton(self.groupBox_7)
        self.radioBtnSpeed1.setObjectName("radioBtnSpeed1")
        self.verticalLayout_6.addWidget(self.radioBtnSpeed1)
        self.radioBtnSpeed10 = QtWidgets.QRadioButton(self.groupBox_7)
        self.radioBtnSpeed10.setObjectName("radioBtnSpeed10")
        self.verticalLayout_6.addWidget(self.radioBtnSpeed10)
        self.gridLayout.addWidget(self.groupBox_7, 5, 3, 2, 1)
        self.lcdArm = QtWidgets.QLCDNumber(self.groupBox_2)
        self.lcdArm.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lcdArm.setObjectName("lcdArm")
        self.gridLayout.addWidget(self.lcdArm, 5, 12, 2, 1)
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setContentsMargins(10, -1, 10, -1)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.label_5 = QtWidgets.QLabel(self.groupBox_2)
        self.label_5.setStyleSheet("font: 100 10pt \"MS Shell Dlg 2\";\n"
"font-weight: bold;\n"
"color: rgb(170, 85, 0);")
        ...
        self.gridLayout.addLayout(self.verticalLayout_9, 0, 2, 1, 3)
        ...
        self.label_15.setStyleSheet("font: 100 10pt \"MS Shell Dlg 2\";\n"
"font-weight: bold;\n"
"color: rgb(170, 85, 0);")
        ...
        self.gridLayout.addLayout(self.verticalLayout_4, 0, 11, 1, 2)
        self.pushBtnMoveBackward = QtWidgets.QPushButton(self.groupBox_2)
        self.pushBtnMoveBackward.setMinimumSize(QtCore.QSize(0, 70))
        self.pushBtnMoveBackward.setObjectName("pushBtnMoveBackward")
        self.gridLayout.addWidget(self.pushBtnMoveBackward, 5, 15, 2, 1)
        spacerItem13 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem13, 5, 13, 1, 1)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.sliderSpeed = QtWidgets.QSlider(self.groupBox_2)
        self.sliderSpeed.setOrientation(QtCore.Qt.Vertical)
        self.sliderSpeed.setObjectName("sliderSpeed")
        self.horizontalLayout_8.addWidget(self.sliderSpeed)
        self.gridLayout.addLayout(self.horizontalLayout_8, 5, 2, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "(Ctrl 0[1, 2, 3])"))
        ...
        self.label_14.setText(_translate("MainWindow", "Foot"))
        self.label_20.setText(_translate("MainWindow", "(+: Alt Q, -: Alt A)"))
        self.radioBtnFoot1.setText(_translate("MainWindow", "1"))
        self.radioBtnFoot10.setText(_translate("MainWindow", "10"))
        ...
        self.radioBtnSpeed1.setText(_translate("MainWindow", "1"))
        self.radioBtnSpeed10.setText(_translate("MainWindow", "10"))
        self.label_5.setText(_translate("MainWindow", "Set speed (%)"))
        self.label_19.setText(_translate("MainWindow", "(+: Q, -: A)"))
        self.label_15.setText(_translate("MainWindow", "Arm"))
        self.label_16.setText(_translate("MainWindow", "(Alt 0[1 ,2, 3])"))
